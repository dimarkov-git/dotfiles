...
// Tuned down from upstream "blaze" defaults. Original had a bright yellow
// trail with a red-orange hot core — visually distracting in actual work.
// Catppuccin Mauve (#cba6f7 = 0.796, 0.651, 0.969) matches both the Mocha
// and Latte palettes. Setting accent == base eliminates the hot core, so
// the trail reads as a single soft shimmer rather than a flame.
const vec4 TRAIL_COLOR = vec4(0.796, 0.651, 0.969, 1.0); // Catppuccin Mauve
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = TRAIL_COLOR; // no hot core
const float DURATION = .3; // shorter than the .5 default = faster fade
